...
public class Siakad {
  ...
  public static void main(String[] args) {
    ...
    while (true) {
      ...
      System.out.println("8. Populate");
      System.out.println("9. Benchmark Sorting WIP");
      ...
      switch (pilih) {
        ...
        case 5:
          ...
          System.out.println(
            "Apakah anda yakin ingin mengedit data tersebut? (y/n)"
          );
              ...
              if (jarak <= 1) {
                ...
                for (int i = 0; i < mahasiswa.size(); i++) {
                    try {
                        ...
                        Mahasiswa m2 = mahasiswa.get(i + jarak);
      
                    
                          
      
                        if (m.getValueByKey(MahasiswaKey.NIM).compareTo(m2.getValueByKey(MahasiswaKey.NIM)) > 0) {
                          Mahasiswa temp = m;
      
                          mahasiswa.set(i, m2);
                          mahasiswa.set(i + jarak, temp);
                          urut = 0;
                        }
  ...
  public static int partition(
    ...
    while (i <= j) {
      while (
        collator.compare(data[i].getValueByKey(key), pivot.getValueByKey(key)) <
        0
      ) {
        i++;
      }
      ...
      while (
        collator.compare(data[j].getValueByKey(key), pivot.getValueByKey(key)) >
        0
      ) {
        j--;
      }
  ...
  public static void insertionSort(Mahasiswa[] data, MahasiswaKey key) {
    for (int i = 1; i < data.length; i++) {
      ...
      while (
        j >= 0 &&
        collator.compare(data[j].getValueByKey(key), temp.getValueByKey(key)) >
        0
      ) {
        // check data j exists
